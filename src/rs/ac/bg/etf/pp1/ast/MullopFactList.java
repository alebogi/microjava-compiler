...
public class MullopFactList extends MulopFactorList {

    private MulopFactorList MulopFactorList;
    private Mulop Mulop;
    private Factor Factor;

    public MullopFactList (MulopFactorList MulopFactorList, Mulop Mulop, Factor Factor) {
