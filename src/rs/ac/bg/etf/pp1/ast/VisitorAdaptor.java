...
public abstract class VisitorAdaptor implements Visitor { 
    ...
    public void visit(OpMul OpMul) { visit(); }
    public void visit(SubOp SubOp) { visit(); }
    public void visit(OpAdd OpAdd) { visit(); }
    public void visit(RelopLE RelopLE) { visit(); }
    public void visit(RelopL RelopL) { visit(); }
    public void visit(RelopGE RelopGE) { visit(); }
    public void visit(RelopG RelopG) { visit(); }
    public void visit(RelopNE RelopNE) { visit(); }
    public void visit(RelopE RelopE) { visit(); }
    ...
    public void visit(NoMullopFactList NoMullopFactList) { visit(); }
    public void visit(MullopFactList MullopFactList) { visit(); }
    public void visit(Term Term) { visit(); }
    public void visit(NoListAddopTerm NoListAddopTerm) { visit(); }
    public void visit(ListAddopTerm ListAddopTerm) { visit(); }
    public void visit(ExprError ExprError) { visit(); }
    public void visit(ExpressionMinus ExpressionMinus) { visit(); }
    ...
    public void visit(LogOr LogOr) { visit(); }
    ...
    public void visit(DesgnStmtNoActPars DesgnStmtNoActPars) { visit(); }
    public void visit(DesgnStmtActPars DesgnStmtActPars) { visit(); }
    public void visit(DesgnStmtAsgnOp DesgnStmtAsgnOp) { visit(); }
    ...
    public void visit(ElseBody ElseBody) { visit(); }
    public void visit(IfCond IfCond) { visit(); }
    public void visit(IfBody IfBody) { visit(); }
    ...
    public void visit(FormParamsList FormParamsList) { visit(); }
    ...
    public void visit(ConstantsListEnd ConstantsListEnd) { visit(); }
    public void visit(NoConstantsList NoConstantsList) { visit(); }
    public void visit(ConstantsList ConstantsList) { visit(); }
    ...
    public void visit(NoDeclarationsList NoDeclarationsList) { visit(); }
